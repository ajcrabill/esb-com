---
layout: post
title: "Your First Data Check-In Is Here — Does Your Budget Match What the Data Says?"
heading: "Your First Data Check-In Is Here — Does Your Budget Match What the Data Says?"
description: "Your board adopted goals in January. Now the first data check-in is on the table alongside the preliminary budget. Here's how to read both together — and what to do when the numbers tell a different story than the spending plan."
author: AJ Crabill
toplevel: Blog
toplevellink: /blog
...
**The Data Is In — Now What? How to Read Your First Progress Monitoring Report for What It Actually Tells You**
...
**Your free CTA:** Reply to this email with the keyword **CheckIn** and I'll send you the Progress Monitoring Decision Protocol — a one-page framework that walks your board through the three-outcome decision structure, with sample language for documenting each outcome in board minutes.
