...
**Your free CTA:** Reply to this email with the keyword **Eval** and I'll send you the Superintendent Evaluation Cycle Timeline & Checklist — a one-page framework that maps your board's adopted goals to the evaluation criteria, evidence sources, and timeline for each evaluation phase. Use it to start the framework confirmation conversation in January.

**Your paid CTA:** Want a clearer picture of how your current superintendent evaluation process stacks up against your adopted goals? I offer a Superintendent Evaluation Process Design & Facilitation — a half-day diagnostic that reviews your current evaluation framework, identifies gaps between your adopted goals and your evaluation criteria, and gives you a roadmap for aligning the two. Reply to this email for pricing and availability.
